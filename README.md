...
You can also download the code as a zip file by clicking on the "<> Code" button on the top right hand side of the github page, then clicking on __Download zip__.
