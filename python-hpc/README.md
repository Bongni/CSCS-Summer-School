...
This repository contains my solutions to the "PyHPC" tutorial from the NVIDIA Accelerated Computing Hub (CSCS Summer School 2026).
The original materials are copyright NVIDIA and are used under the repository's license.
The solution code is my own.

Original tutorial: https://github.com/NVIDIA/accelerated-computing-hub/tree/event/2026-07-cscs-summer-school/tutoria

Original materials © NVIDIA, licensed under CC BY-NC-SA 4.0. My solutions and modifications are also licensed under CC BY-NC-SA 4.0.
